...
import image from './assets/Auction Strory 1.png';
const AuctionPage = () => {
  return (
    <div className="bg-gray-100">
      {/* Hero Section */}
      <div className="relative w-full h-screen bg-cover bg-center" style={{ backgroundImage: image }}>
      ...
      <section className="flex flex-col lg:flex-row min-h-screen">
        <div className="w-full lg:w-1/2 h-full flex justify-end items-start pt-8 pr-4">
          <img src="assets/Auction Strory 1.png" alt="Auction Image" className="object-cover w-[80%] h-auto object-right-top" />
        </div>
      ...
      <section className="flex flex-col lg:flex-row min-h-screen">
        ...
        <div className="w-full lg:w-1/2 h-full flex justify-start items-end pt-20 pr-10">
          <img src="assets/Auction story 2.png" alt="Auction Image" className="object-cover w-[90%] h-auto object-right-top" />
        </div>
      </section>
    </div>
  );
